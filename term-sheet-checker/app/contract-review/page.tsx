        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-purple-50 border border-purple-200 rounded-full mb-6">
              ...
              <span className="text-purple-800 font-semibold text-xs uppercase tracking-wide">Contract Review GPT</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-100 to-purple-50 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-5 h-5 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="font-semibold text-navy-900 mb-2">Risk Identification</h3>
              <p className="text-gray-600 text-sm">Automatically flags problematic clauses, one-sided terms, and potential liability issues.</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              ...
              <h3 className="font-semibold text-navy-900 mb-2">Plain English Summaries</h3>
              <p className="text-gray-600 text-sm">Complex legal language translated into clear, understandable explanations of what you&apos;re agreeing to.</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              ...
              <h3 className="font-semibold text-navy-900 mb-2">Redline Suggestions</h3>
              <p className="text-gray-600 text-sm">Get specific alternative language to negotiate better terms and protect your interests.</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              ...
              <h3 className="font-semibold text-navy-900 mb-2">Any Contract Type</h3>
              <p className="text-gray-600 text-sm">Works with NDAs, service agreements, employment contracts, vendor agreements, and more.</p>
            </div>
          </div>
