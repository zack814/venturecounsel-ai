    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="hero-gradient subtle-grid pt-28 pb-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Tools Grid */}
          <div id="tools" className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto mb-20 scroll-mt-24">
            ...
            <Link href="/comp-optimizer" className="group card-hover">
              <div className="bg-white border border-gray-200/80 rounded-2xl p-6 h-full shadow-sm hover:shadow-lg hover:border-emerald-200 transition-all">
                ...
                <span className="inline-block px-2.5 py-1 bg-emerald-50 text-emerald-700 font-semibold text-xs uppercase tracking-wide rounded-md mb-3">Founders</span>
                <h2 className="text-lg font-bold text-navy-900 mb-2">
                  Comp Optimizer
                </h2>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
            ...
            {/* Offer Evaluator Card */}
            <Link href="/offer-evaluator" className="group card-hover">
              <div className="bg-white border border-gray-200/80 rounded-2xl p-6 h-full shadow-sm hover:shadow-lg hover:border-rose-200 transition-all">
                <div className="w-12 h-12 bg-gradient-to-br from-rose-100 to-rose-50 rounded-xl flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                  <svg className="w-6 h-6 text-rose-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <span className="inline-block px-2.5 py-1 bg-rose-50 text-rose-700 font-semibold text-xs uppercase tracking-wide rounded-md mb-3">Employees</span>
                <h2 className="text-lg font-bold text-navy-900 mb-2">
                  Offer Evaluator
                </h2>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Evaluate startup offers with equity benchmarks & negotiation tips.
                </p>
            ...
            {/* Token Risk Analyzer Card */}
            <Link href="/token-risk-analyzer" className="group card-hover">
              <div className="bg-white border border-gray-200/80 rounded-2xl p-6 h-full shadow-sm hover:shadow-lg hover:border-cyan-200 transition-all">
                <div className="w-12 h-12 bg-gradient-to-br from-cyan-100 to-cyan-50 rounded-xl flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                  <svg className="w-6 h-6 text-cyan-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <span className="inline-block px-2.5 py-1 bg-cyan-50 text-cyan-700 font-semibold text-xs uppercase tracking-wide rounded-md mb-3">Crypto</span>
                <h2 className="text-lg font-bold text-navy-900 mb-2">
                  Token Risk Analyzer
                </h2>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Howey test analysis for your token&apos;s securities risk.
                </p>
