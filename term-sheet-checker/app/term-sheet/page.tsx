        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-full mb-6">
              ...
              <span className="text-blue-900 font-semibold text-xs uppercase tracking-wide">Term Sheet Analyzer GPT</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-slate-900 mb-2">Market Benchmarking</h3>
              <p className="text-slate-600 text-sm">Compare your terms against current market standards for your stage and deal type.</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <p className="text-slate-600 text-sm">Automatically flags deal-killers, aggressive terms, and potential founder traps.</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-slate-900 mb-2">Alternative Language</h3>
              <p className="text-slate-600 text-sm">Get specific redline suggestions and fallback positions for problematic clauses.</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <h3 className="font-semibold text-slate-900 mb-2">Negotiation Strategy</h3>
              <p className="text-slate-600 text-sm">Receive prioritized negotiation guidance with leverage analysis and trade-off recommendations.</p>
            </div>
          </div>
