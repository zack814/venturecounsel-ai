          ...
          <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-3xl p-8 sm:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-100 border border-blue-200 rounded-full mb-6">
                <span className="text-blue-900 font-semibold text-xs uppercase tracking-wide">Our Mission</span>
              </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {teamMembers.map((member) => (
                <div key={member.name} className="bg-white border border-slate-200 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-4">
                      {member.credentials.map((cred) => (
                        <span key={cred} className="px-2 py-1 bg-slate-100 text-slate-600 text-xs rounded-full">
                          {cred}
                        </span>
                      ))}
                    </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {advisors.map((advisor) => (
                <div key={advisor.name} className="bg-slate-50 rounded-xl p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 text-sm font-medium">{advisor.role}</p>
                    </div>
                  </div>
                  <p className="text-slate-600 text-sm mb-3">{advisor.bio}</p>
                  <span className="inline-block px-2 py-1 bg-white text-slate-600 text-xs rounded-full border border-slate-200">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">We&apos;re clear about what we can and can&apos;t do. AI isn&apos;t a replacement for legal counsel.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">We&apos;ve been in your shoes. We build tools we&apos;d want to use ourselves.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm">Legal knowledge shouldn&apos;t be gatekept by ability to pay $1,000/hour.</p>
                    </div>
                  </div>
                </div>
              </div>
